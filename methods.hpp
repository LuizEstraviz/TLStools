...
void saveStemsOnly(vector<vector<StemSegment>>& stemsList, float pixel, string input_path, string file_path = "teste.txt",
                   string cloud_path = "teste.laz", float max_rad = 0.25);
